...
class _WelcomePageState extends State<WelcomePage> {
  ...
  Widget _buildExampleElementWidget(String name, Function onClicked) => Material(
    child: InkWell(
  ...
  Future<void> _saveAssetSubtitleToFile() async {
    final String content = await rootBundle.loadString('assets/example_subtitles.srt');
  ...
  Future<void> _saveAssetVideoToFile() async {
  ...
  Future<void> _saveAssetEncryptVideoToFile() async {
    final content = await rootBundle.load('assets/${Constants.fileTestVideoEncryptUrl}');
    final directory = await getApplicationDocumentsDirectory();
  ...
  Future<void> _saveLogoToFile() async {
